					...
					<Card className='border-0 shadow-xl bg-white/80 backdrop-blur-sm'>
						...
						<CardContent>
							<p className='text-gray-600 leading-relaxed'>
								By accessing and using Techinsiders tool
					...
					<Card className='border-0 shadow-xl bg-white/80 backdrop-blur-sm'>
						...
						<CardContent className='space-y-4'>
							...
							<div>
								...
								<p className='text-gray-600'>
									In no event shall Techinsiders tool be liable for
					...
					<Card className='border-0 shadow-xl bg-white/80 backdrop-blur-sm'>
						...
						<CardContent className='space-y-4'>
							<div>
								...
								<ul className='list-disc list-inside text-gray-600 space-y-1'>
									<li>
										Techinsiders tool and its original content are
					...
					<Card className='border-0 shadow-xl bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white'>
						<CardContent className='p-6'>
							...
							<p className='text-blue-100 text-sm'>
								By using Techinsiders tool, you acknowledge that you
