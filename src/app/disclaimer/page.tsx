					...
					<Card className='border-0 shadow-xl bg-white/80 backdrop-blur-sm'>
						...
						<CardContent>
							<p className='text-gray-600 leading-relaxed'>
								The information and tools provided by Techinsiders tools are for general informational and utility
					...
					<Card className='border-0 shadow-xl bg-white/80 backdrop-blur-sm'>
						...
						<CardContent>
							...
							<div className='space-y-2 text-gray-600'>
								<p>
									<strong>Email:</strong> techinsiderstech@gmail.com
								</p>
								<p>
					...
					<Card className='border-0 shadow-xl bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 text-white'>
						<CardContent className='p-6'>
							...
							<p className='text-orange-100 text-sm'>
								By using Techinsiders tools, you acknowledge that you
